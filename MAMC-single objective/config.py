...
# General settings
parser.add_argument("--algorithm", type = str, default = "MAMC-SO", help = "Algorithm name")
...
parser.add_argument("--actor_learning_rate", type = float, default = 1e-5, help = "Learning rate of the actor")
